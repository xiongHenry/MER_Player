...
- (void)updateVolumeIndicator:(CGFloat)value
{
    ...
    if (self.superview.accessibilityIdentifier) {
        MER_PlayerControllerView *playerView = (MER_PlayerControllerView *)self.superview;
        playerView.isHiddenTimeIndicatorView       = YES;
        playerView.isHiddenbrightnessIndicatorView = YES;
    } else {
